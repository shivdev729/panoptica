...
public class ArtifactService {
    ...
    public Page<ArtifactResponse> filter(ArtifactFilterRequest f) {
        ...
        return artifactRepo.filter(
                ...
                nullIfBlank(f.dynastyName()),
                nullIfBlank(f.museumId()),nullIfBlank(f.museumName()),
                 nullIfBlank(f.material()),
                f.status(), nullIfBlank(f.name()),
                nullIfBlank(f.regionId()),nullIfBlank(f.regionName()), pageable
